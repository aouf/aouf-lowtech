...
if (isset($_POST['login'])) {
    ...
    if ((($email == null)&&($_SESSION['user_category']!='deloge')) || (($email == null)&&($_SESSION['user_category']!='coordinateur')) || (($email == null)&&($_SESSION['user_category']!='couches'))) { print "<div class='erreur noir bg-saumon center'>Erreur, vous devez avoir une adresse email&nbsp;!</div>"; goto skip; }
    ...
    if ((($phone == null)&&($_SESSION['user_category']=='deloge')) || (($phone == null)&&($_SESSION['user_category']=='coordinateur')) || (($phone == null)&&($_SESSION['user_category']=='couches'))) { print "<div class='erreur noir bg-saumon center'>Erreur, vous devez avoir un numéro de téléphone&nbsp;!</div>"; goto skip; }
...
<?php if ($_SESSION['user_category']=='deloge' || $_SESSION['user_category']=='coordinateur' || $_SESSION['user_category']=='couches') { ?>
