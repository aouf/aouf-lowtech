...
<div class="container bg-blanc noir full-size">
    <div class="content">
        ...
        <h2>Proposer une offre</h2>
            ...
            <p>Catégorie de l'offre : <?php echo $category; ?></p>
            <label for="">Arrondissement<span class="saumon">*</span></label>
            ...
            <textarea name='description1' placeholder="Description 1 ici…"></textarea>
            <textarea name='description2' placeholder="Description 2 ici…"></textarea>
            <textarea name='description3' placeholder="Description 3 ici…"></textarea>
