...
";
            ...
            $req = "select phonenumber from users where category='deloge' and status='enabled' and ( notification='sms' or notification='email+sms' ) and accept_mailing='yes' and arrondissement=$arrondissement";
