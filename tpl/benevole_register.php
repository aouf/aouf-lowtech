...
<body>
    ...
    <div class='container no-margin full-size noir center'>
        <form id="registerForm" class='full-size column' method='post'>
            ...
            <label for="cgu"><input type="checkbox" value="" id="" name="cgu" required> J'ai lu et j'accepte les <a class="small-text saumon" href="/cgu">CGU</a></label><br>
            <label><input type="checkbox" value="" id="" required> J'accepte que les informations saisies soient utilisées pour la gestion de l'application <strong>Aouf</strong></label><br>
            <label for=""><input type="checkbox" value="" id=""> J'accepte de recevoir des informations d'Aouf <span class="saumon">(optionnel)</span></label><br>
